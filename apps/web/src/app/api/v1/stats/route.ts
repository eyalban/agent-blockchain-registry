 ...
 * company. Agents registered through the framework's Path B / Path C
 * flow show up immediately via the `company_members` mirror, even
 * before they ever link a separate wallet.
 *
